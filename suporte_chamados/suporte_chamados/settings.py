"""
Django settings for suporte_chamados project.
...
SECRET_KEY = 'django-insecure-v9ot4o)r2()!%mako$m+l&a80i@8v*zfmi7acxf)k41!u%h18-'
...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True,  # Permite que o Django procure templates dentro dos aplicativos
        'OPTIONS': {
            'context_processors': [
